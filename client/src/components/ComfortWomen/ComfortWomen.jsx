...
const ComfortWomen = () => {
    const [selectedTitle, setSelectedTitle] = useState("¿Quiénes son?"); // Step 3
                ...
                <div className={style.infoDiv}>
                    ...
                    <div className={style.contentDiv}>
                        <div className={style.summaryDiv}>
                            <p>{textData.find(item => item.title === selectedTitle)?.summary}</p> {/* Display selected title */}
                        </div>
                        <div className={style.textDiv}>
                            <p>{textData.find(item => item.title === selectedTitle)?.text}</p> {/* Display selected text */}
                        </div>
                    </div>
                </div>
            </div>
